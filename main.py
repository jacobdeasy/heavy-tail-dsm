...
def parse_args_and_config():
    ...
    parser.add_argument('--input1', type=str, default='./', help='Folder of samples for metrics.')
    parser.add_argument('--input2', type=str, default='./', help='Folder of reference data for metrics.')
